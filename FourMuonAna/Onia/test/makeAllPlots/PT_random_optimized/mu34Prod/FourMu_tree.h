...
// Sun Nov 24 11:11:32 2019 by ROOT version 6.10/09
// from TTree FourMu_tree/A ROOT tree
// found on file: fourMuMass_tree_mu34.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("fourMuMass_tree_mu34.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("fourMuMass_tree_mu34.root");
      }
